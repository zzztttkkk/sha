...
func RegisterRegexp(name string, rp *regexp.Regexp) { regexpMap[name] = rp }

func RegisterBytesFilter(name string, fn func(v []byte) ([]byte, bool)) { bytesFilterMap[name] = fn }
