...
func (rule *_Rule) validateOne(field *reflect.Value) *Error {
	switch rule.rtype {
	case _CustomType:
...
func (rule *_Rule) validateSlice(field *reflect.Value) *Error {
	vi := field.Interface()
...
func ValidateStruct(vPtr interface{}) (err *Error) {
